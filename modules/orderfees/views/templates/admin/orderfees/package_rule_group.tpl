...
<tr id="package_rule_group_{$package_rule_group_id|intval}_tr">
    ...
    <td>
        <div class="form-group">
            <label class="control-label col-lg-3">{l s='Weight/Volume ratio' mod='orderfees'}</label>
        ...
        <div class="form-group">
            <label class="control-label col-lg-3">{l s='Add a range'  mod='orderfees'}</label>
        ...
        <table id="package_rule_table_{$package_rule_group_id|intval}" class="table table-bordered">
            <thead>
                <tr>
                    <th>{l s='Range' mod='orderfees'}</th>
                    <th>{l s='Round' mod='orderfees'}</th>
                    <th>{l s='Divider' mod='orderfees'}</th>
                    <th colspan="4">{l s='Amount' mod='orderfees'}</th>
                </tr>
            </thead>

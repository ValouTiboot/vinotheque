...
include_once(dirname(__FILE__).'/class/productnews.class.php');
    ...
    */
    ...
    private function postForm()
    {
        ...
        if (Tools::isSubmit('deleteNews') && Tools::getValue('idN')) {
                    ...
                    if ($_FILES['homepage_logo']['name']) {
                        if (!$this->uploadImage($_FILES['homepage_logo'], $news->id, $this->normal_image_size_width, $this->normal_image_size_height)) {
                            ...
                            foreach (self::scanListeThemes() as $value_theme) {
                                ...
                                $this->imageResize(
                                    dirname(__FILE__).'/views/img/'.$value_theme.'/up-img/'.$news->id.'.jpg',
                    ...
                    if (!$this->demo_mode) {
                        if ($_FILES['imageCategory']['name']) {
                            if (!$this->uploadImage($_FILES['imageCategory'], $categories->id, $this->normal_image_size_width, $this->normal_image_size_height, 'c')) {
                                ...
                                foreach (self::scanListeThemes() as $value_theme) {
                                    $this->imageResize(
                                        dirname(__FILE__).'/views/img/'.$value_theme.'/up-img/c/'.$categories->id.'.jpg',
                    ...
                    if ($_FILES['homepage_logo']['name']) {
                        if (!$this->uploadImage($_FILES['homepage_logo'], Tools::getValue('idN'), $this->normal_image_size_width, $this->normal_image_size_height)) {
                            ...
                            foreach (self::scanListeThemes() as $value_theme) {
                                $config_theme = $this->getConfigXmlTheme($value_theme);
                                $this->imageResize(
                                    dirname(__FILE__).'/views/img/'.$value_theme.'/up-img/'.Tools::getValue('idN').'.jpg',
                    ...
                    if (!$this->demo_mode) {
                        if ($_FILES['imageLookbook']['name']) {
                            if (!$this->uploadImage($_FILES['imageLookbook'], $lookbook->id, $this->normal_image_size_width, $this->normal_image_size_height, 'lookbook')) {
                                ...
                                foreach (self::scanListeThemes() as $value_theme) {
                                    $this->imageResize(
                                        dirname(__FILE__).'/views/img/'.$value_theme.'/up-img/lookbook/'.$lookbook->id.'.jpg',
                                        dirname(__FILE__).'/views/img/'.$value_theme.'/up-img/lookbook/lbcrop_'.$lookbook->id.'.jpg',
                                    ...
                                    $this->autocropImage(
                                        $lookbook->id.'.jpg',
                                        dirname(__FILE__).'/views/img/'.$value_theme.'/up-img/lookbook/',
                                        dirname(__FILE__).'/views/img/'.$value_theme.'/up-img/lookbook/',
                                        (int)$this->admin_thumb_image_size_width,
                                        (int)$this->admin_thumb_image_size_height,
                                        'adminth_',
            ...
            $post_en_cours = true;
            if (!file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/lookbook/'.Tools::getValue('idLB').'.jpg')) {
                $errors[] = $this->l('This action cannot be taken.');
            } else {
            ...
            if (!file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/admincrop_'.Tools::getValue('idN').'.jpg')) {
                ...
                list($w_image_base, $h_image_base) = getimagesize(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/admincrop_'.Tools::getValue('idN').'.jpg');
            ...
            if (!file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/c/admincrop_'.Tools::getValue('idC').'.jpg')) {
                ...
                list($w_image_base, $h_image_base) = getimagesize(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/c/admincrop_'.Tools::getValue('idC').'.jpg');
    ...
    private function displayHome()
    {
        ...
        if (count($liste_news) > 0) {
            foreach ($liste_news as $value_n) {
                $this->html_out .= '<div class="blocmodule">'."\n";
                if (file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/adminth_'.$value_n['id_'.$this->name.'_news'].'.jpg')) {
            ...
            foreach ($blocks_dash_board as $v_block) {
                ...
                if (count($news_liste) > 0) {
                    ...
                    foreach ($news_liste as $v_news) {
                        ...
                        if (file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/adminth_'.(int)$v_news['id_'.$this->name.'_news'].'.jpg')) {
    ...
    private function displayListeNews()
    {
        ...
        if (count($liste) > 0) {
            foreach ($liste as $value) {
                ...
                if (file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/adminth_'.$value['id_'.$this->name.'_news'].'.jpg')) {
    ...
    private function displayListeLookBook()
    {
        ...
        if ((int)$count_liste > 0) {
            foreach ($liste as $value) {
                ...
                if (file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/lookbook/adminth_'.$value['id_prestablog_lookbook'].'.jpg')) {
    ...
    private function displayOrderTreeCategories($liste, &$count = 0)
    {
        ...
        foreach ($liste as $value) {
            ...
            if (file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/c/adminth_'.$value['id_'.$this->name.'_categorie'].'.jpg')) {
                $html_out .= '
                    <img
                        class="thumb"
    ...
    private function displayFormNews()
    {
        ...
        if (Tools::getValue('idN')
            && file_exists(
                dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/admincrop_'.Tools::getValue('idN').'.jpg'
            )
        ) {
            ...
            foreach ($config_theme_array['images'] as $key_theme_array => $value_theme_array) {
                $width_force = '';
                if (file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/'.$key_theme_array.'_'.Tools::getValue('idN').'.jpg')) {
                    $attrib_image = getimagesize(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/'.$key_theme_array.'_'.Tools::getValue('idN').'.jpg');
        ...
        foreach ($languages as $language) {
            $html_libre .= '
                <div id="cpara1_'.$language['id_lang'].'"
                    style="display: '.($language['id_lang'] == $default_language ? 'block' : 'none').';"
                >
                    <textarea maxlength="'.(int)Configuration::get('prestablog_news_intro_length').'"
                    ...
                    <p>
                        ...
                        <span id="compteur-texte-'.$language['id_lang'].'" style="color:red;">
                            '.Tools::strlen($news->paragraph[$language['id_lang']]).' /
                            '.(int)Configuration::get('prestablog_news_intro_length').'
                        </span>
                        <br/>
                        '.$this->l('You can configure the max length in the general configuration of the module theme.').'
                    </p>
            </div>';
        }
        $this->html_out .= $this->displayFormLibre(
    ...
    private function displayFormCategories()
    {
        ...
        if (Tools::getValue('idC')
            && file_exists(
                dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/c/admincrop_'.Tools::getValue('idC').'.jpg'
            )
        ) {
            $html_libre .= '<span id="labelPicture"></span>';
            $config_theme_array = PrestaBlog::objectToArray($config_theme);
            ...
            $html_libre .= '
                <div id="image" class="col-md-7">
                    <div class="blocmodule">
                        ...
                        <p align="center">
                            '.$this->l('Filesize').'
                            '.(filesize(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/c/'.Tools::getValue('idC').'.jpg') / 1000).'kb
                        </p>
                        <p>
            ...
            foreach ($config_theme_array['categories'] as $key_theme_array => $value_theme_array) {
                $width_force = '';
                if (file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/c/'.$key_theme_array.'_'.Tools::getValue('idC').'.jpg')) {
                    $attrib_image = getimagesize(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/c/'.$key_theme_array.'_'.Tools::getValue('idC').'.jpg');
                    if ((int)$attrib_image[0] > 200) {
                        $width_force = 'width="200"';
                    }
                }
    ...
    private function displayFormLookbook()
    {
        ...
        if (Tools::getValue('idLB')
            && file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/lookbook/lbcrop_'.(int)Tools::getValue('idLB').'.jpg')
            && file_exists(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/lookbook/'.(int)Tools::getValue('idLB').'.jpg')
        ) {
            $html_libre .= '
            ...
            list($largeur_canvas_edition, $hauteur_canvas_edition) = getimagesize(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/lookbook/lbcrop_'.(int)Tools::getValue('idLB').'.jpg');

            list($largeur_canvas_final, $hauteur_canvas_final) = getimagesize(dirname(__FILE__).'/views/img/'.Configuration::get($this->name.'_theme').'/up-img/lookbook/'.(int)Tools::getValue('idLB').'.jpg');
        ...
        if (isset($file_image) && isset($file_image['tmp_name']) && !empty($file_image['tmp_name'])) {
            ...
            if (ImageManager::validateUpload($file_image, $this->max_image_size)) {
                ...
                foreach (self::scanListeThemes() as $value_theme) {
                    if (!$this->imageResize(
                        $tmpname,
                        dirname(__FILE__).'/views/img/'.$value_theme.'/up-img/'.($folder ? $folder.'/' : '').$id.'.jpg',
                        $w,
                        $h
                    )) {
                        return false;

...
<p id="loyalty">
	<img src="{$module_dir|escape:'html':'UTF-8'}views/img/loyalty.gif" alt="{l s='loyalty' mod='totloyaltyadvanced'}" class="icon" />
	{if $points > 0}
		...
		{l s='that can be converted into a voucher of' mod='totloyaltyadvanced'} {$voucher|escape:'htmlall':'UTF-8'}{if isset($guest_checkout) && $guest_checkout}<sup>*</sup>{/if}.<br />

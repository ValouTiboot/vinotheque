...
class BAMegaMenu extends Module
{
    ...
    protected function getMegamenu($id = "", $id_shop = null)
    {
        ...
        if ($this->context->cookie->finter_lang != '') {
            $where[] = "id_lang=" . $this->context->cookie->finter_lang;
        }
    ...
    protected function getHook($row = '', $id = '', $selected = array())
    {
        ...
        $html = '';
        $html.='<select id="select_category" name="sub[' . $row . '][' . $id . '][]">';
        foreach ($returns as $value) {
            $html.='<option ' . (in_array($value['name'], $selected) == true ? "selected" : "")
    ...
    private function renderFormConfigMega()
    {
        ...
        $this->ps_html .= '<div class="form-group">
                            ...
                            <div class="col-lg-8">
                                ...
                                . $this->ps_cipherTool->decrypt(Configuration::get('bamenu_ccss')) . '</textarea>
                            </div>
                        </div>';
        $this->ps_html .= '</div>';
        $this->ps_html .= '</div>';
    ...
    private function renderFormListLabel()
    {
        ...
        foreach ($languages as $val) {
            ...
            . (($finter_lang_tmp != '') && ($finter_lang_tmp == $val['id_lang']) ? "selected" : "")
            . ' value="' . (int) $val['id_lang'] . '">' . $val['name'] . '</option>';
        }
        ...
        for ($i = 0; $i < count($menu); $i++) {
            ...
            //var_dump($menu);die;
            $this->ps_html .='<tr class="listmenu ' . $odd . '" >';
            $this->ps_html .='<td class="text-center"><input type="hidden" value="'
            . $menu[$i]['id'] . '">' . $menu[$i]['id'] . '</td>';
            $this->ps_html .='<td class="text-left">' . $menu[$i]['label'] . '</td>';
            $this->ps_html .='<td class="text-center">' . $languages_arr[$menu[$i]['id_lang']]['name'] . '</td>';
    ...
    private function addMenu()
    {
        if (Tools::getValue('action') == 'addlabel') {
            ...
            $this->ps_html .= '<input type="hidden" id="action" name="action" value="">';
            $this->ps_html .= '<input type="hidden" name="id" id="id" value="'
            . (Tools::getValue('id') != '' ? Tools::getValue('id') : '') . '">';
            ...
            $this->ps_html .= '<div class="panel-heading">'. $actionMGMenuAdmin
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    onchange="SelectTypeLink(0,this,0)">
                                                        ...
                                                        <option value="phpcode">' . $this->l('Php Code') . '</option>
        ...
        if (Tools::getValue('action') == 'editlabel' || Tools::getValue('action') == 'savestay') {
            ...
            if (empty($subs)) {
                ...
                foreach ($subs as $key => $sub) {
                    $this->ps_html .='<div class="add_row row_' . $key . ' ' . ($key == $size ? "end_row" : "") . '">
                                            <div class="row_size">
                                                <label>'.$this->l('Row Size:').' </label>
                                                <select name="size[' . $key . '][]" id="row_size_'
                                                . $key . '" onchange="createcol(' . $key . ',\'row_size_' . $key . '\','
                                                . $key . ')">
                                                ...
                                                . ($key > 0 ? 'onclick="removerow(' . $key . ')' : '')
                                                . '" >'.$this->l('Remove Row').'</label>
                                            </div>';
                    $this->ps_html .='<div class="list_col list_col_' . $key . '">';
                    foreach ($sub as $k => $col) {
                        $this->ps_html .='<div class="col col_' . $k . '" '
                        . ((count($sub) > 1) ? "style='float: left; width: 295px;'" : "") . '>
                                            <div class="cancel_col" onclick="cancel_col('
                                            . $key . ',' . $k . ')"><i class="process-icon-cancel "></i></div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-3">
                                                    ' . $this->l('Label:') . '
                                                </label>
                                                <div class="col-lg-9">
                                                    ...
                                                    . $k . '" class="copy2friendlyUrl updateCurrentText" name="sub['
                                                    . $key . '][' . $k . '][]" value="'
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" id="customclass_col_' . $k
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" id="width_col_' . $k
                                                    . '" class="copy2friendlyUrl updateCurrentText" name="sub['
                                                    . $key . '][' . $k . '][]" value="'
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="sub[' . $key . ']['.$k.'][]" id="typelink_col_'
                                                    . $k . '" onchange="SelectTypeLink('.$key. ',this,' . $k . ')">
                                                        <option value="">' . $this->l('Hide This') . '</option>
                                                        ...
                                                        <option ' . ($col[3] == "phpcode" ? "selected" : "")
                                                        . ' value="phpcode">' . $this->l('Php Code') . '</option>
                                                    ...
                                                    <br>
                                                    <div class="custom_url_col custom_url_col_' . $k . '">
                                                        <script type="text/javascript">
                                                            SelectEditTypeLink(' . $key . ',"'
                                                            . $col[3] . '",' . $k . ',' . $menu['id'] . ')
                                                        </script>
                                                    </div>
                                                </div>
        ...
        if (Tools::getValue('action') == 'savelabel' || Tools::getValue('action') == 'savestay') {
            ...
            if (!empty($labelmenu)) {
                ...
                if (Tools::getValue('id') == 0) {
                    ...
                    VALUES ('" . pSQL($labelmenu) . "','" . pSQL($customclass) . "'," . $submenu . ",'"
                    . $typelink . "','" . pSQL($custom_url) . "','" . $typelink_one . "','"
                    . $custom_url_one . "'," . $make . "," . $fullwidth . ",'" . $sub . "'," . $position
                    . "," . $id_lang . ",".$mega_id_shop. ",". $status . ");";
                    Db::getInstance()->execute($sql);
                    $id_menu_new=Db::getInstance()->Insert_ID();
                } else {
                    $sql = "UPDATE " . _DB_PREFIX_ . "megamenu SET `label`='" . pSQL($labelmenu) . "',`customclass`='"
                    . pSQL($customclass) . "',`submenu`=" . $submenu . ",`typelink`='" . $typelink
                    . "',`custom_url`='" . pSQL($custom_url) . "',`typelink_one`='" . $typelink_one
                    . "',`custom_url_one`='" . $custom_url_one . "',`make`=" . $make . ",`fullwidth`="
                    . $fullwidth . ",`sub`='" . $sub . "',`id_lang`=" . $id_lang . ",`action`=" . $status
    ...
    private function getSubMenuProduct($id, $list = 0)
    {
        ...
        if (!Validate::isLoadedObject(new Product($id)))
            return false;
        ...
        if (Tools::version_compare(_PS_VERSION_, '1.7', '>='))
        {
            ...
            $html .= '<div class="name">';
            $html .= '<h1 itemprop="name"><a href="' . $product['url'] . '">' . Tools::HtmlEntitiesUTF8($product['name']) . '</a></h1>';
            $html .= '<span class="feature-name">';
            $html .= isset($product['features'][5]['value']) && isset($product['features'][6]['value']) ? $product['features'][5]['value'] . ' - ' . $product['features'][6]['value'] : '';
            $html .= '</span>';
            $html .= '</div>';
    ...
    {
        $sql_cat = "SELECT * FROM  " . _DB_PREFIX_ . "category WHERE id_category=" . $cat_id;
        $results_cat = Db::getInstance()->executeS($sql_cat);
        $results_cat = $results_cat[0];
        $sql = "SELECT id_category FROM  " . _DB_PREFIX_ . "category WHERE nleft>" . $results_cat['nleft']
        . " AND nright<" . $results_cat['nright'];
    ...
    private function getSubMenuCode($content)
    {
        $content = str_replace(array('<?=', '<?php', '?>', '<?'), '', $content);
        ob_start();
        
        $content = $this->exePHP($content);
        ob_end_clean();
        $html = '';
        $html .="<ul class='menucode clearfix'>";
        $html .="<li>";
        $html .="<div class='phpcode'>" . $content . "</div>";
        $html .="</li>";
        $html .="</ul>";
        /* $html .="<script type='text/javascript'>
          var base_url='".$this->getBaseURL().'/modules/'.$this->name."';
          phpcode();</script>"; */
        return $html;
    }
                            ...
                            foreach ($sub as $k => $col) {
                                if (!empty($col)) {
                                    ...
                                    switch ($col[3]) {
                                        ...
                                        case 'phpcode':
                                            if (!empty($col[4])) {
                                                $this->ps_menu .=$this->getSubMenuCode($col[4]);
                                            }

...
$(function () {
	...
	if(check_typelink=='url'){
			var str = 'typelink=url&iditem='+$("input[name=id]").val()+'&mega_id_shop='+mega_id_shop;
			$.ajax({		  
				type: 'POST',		 
			...
			var str = 'typelink=existlinks&iditem='+$("input[name=id]").val()+'&mega_id_shop='+mega_id_shop;
			$.ajax({		  
				type: 'POST',		 
				url: base_url+'/ajax_editmenu.php',		  
				data: str,		 
	...
	if(check_typelink_one=='externallink'){
			var str = 'typelink=externallink&iditem='+$("input[name=id]").val()+'&mega_id_shop='+mega_id_shop;
			$.ajax({		  
				type: 'POST',		 
				url: base_url+'/ajax_editmenu.php',		  
				data: str,		 
			...
			var str = 'typelink=systemlink&name=_one&iditem='+$("input[name=id]").val()+'&mega_id_shop='+mega_id_shop;
			$.ajax({		  
				type: 'POST',		 
				url: base_url+'/ajax_editmenu.php',		  
				data: str,		 
			...
			var str = 'typelink=htmllink&name=custom_url_one&iditem='+$("input[name=id]").val()+'&mega_id_shop='+mega_id_shop;
			$.ajax({		  
				type: 'POST',		 
				url: base_url+'/ajax_editmenu.php',		  
				data: str,		 
					...
					addrow+='<div class="col col_0">';
						...
						addrow+='<div class="form-group">';	
							...
							addrow+='<div class="col-lg-9">';
								...
								addrow+='<option value="phpcode">Php Code</option>';
					...
					col+='<div class="col col_'+i+'">';
						...
						col+='<div class="form-group">';	
							...
							col+='<div class="col-lg-9">';
								...
								col+='<option value="phpcode">Php Code</option>';
...
function SelectTypeLink(row,type,id){
	...
	switch(type.value){
		case 'link':
			var str = 'name='+'_col_'+id+'&type=multiple&id='+id+'&row='+row+'&mega_id_shop='+mega_id_shop;
			$.ajax({		  
				type: 'POST',		 
		...
		break;
		case 'phpcode':$(".row_"+row+" .custom_url_col_"+id).html('<div class="btn btn-default" onclick="ViewEditHtml('+row+','+id+')" ><i class="process-icon-edit "></i><span>View/Edit Php</span></div><div class="view_edit_html" style="display:none"><textarea class="autoload_rte" aria-hidden="true" id="sub_'+row+'_'+id+'" name="sub['+row+']['+id+'][]" rows="15" cols="15"></textarea></div>');
		break;
		case 'loadhook':
			var str = 'name='+'_col_'+id+'&hook=loadhook&id='+id+'&row='+row;
			$.ajax({		  
				type: 'POST',		 
				url: base_url+'/ajax_submenu.php',		  
				data: str,		 
		...
		break;
		case 'productlist':
			var str = 'name='+'_col_'+id+'&product=productlist&id='+id+'&row='+row+'&mega_id_shop='+mega_id_shop;
			$.ajax({		  
				type: 'POST',		 
				url: base_url+'/ajax_submenu.php',		  
				data: str,		 
...
function SelectEditTypeLink(row,type,id,iditem){
	var mega_id_shop=$("#mega_id_shop").val();
	var str = 'name='+'_col_'+id+'&type=multiple&id='+id+'&row='+row+'&iditem='+iditem+'&typelink='+type+'&mega_id_shop='+mega_id_shop;
		$.ajax({		  
			type: 'POST',		 
			url: base_url+'/ajax_editmenu.php',		  
			data: str,		 

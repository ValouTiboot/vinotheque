...
<div class="row">
    <div class="col-xs-12">
        <div id="pm_support_informations" class="panel">
            <h2>{l s='Useful links' mod='pm_multiplefeatures'}</h2>

            <ul class="pm_links_block">
                <li class="pm_module_version"><strong>{l s='Module Version: ' mod='pm_multiplefeatures'}</strong> {$pm_module_version|escape:'htmlall':'UTF-8'}</li>

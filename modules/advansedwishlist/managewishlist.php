...
require_once(dirname(__FILE__).'/advansedwishlist.php');
    ...
    if (empty($id_wishlist) === false) {
        if (!strcmp($action, 'update')) {
            ...
            if (!strcmp($action, 'delete')) {
                Ws_WishList::removeProduct($id_wishlist, (int)$context->customer->id, $id_product, $id_product_attribute);
            }

            $products = Ws_WishList::getProductByIdCustomer($id_wishlist, $context->customer->id, $context->language->id);
            ...
            $context->smarty->assign(array(
                    ...
                    'wishlists' => Ws_WishList::getByIdCustomer(Context::getContext()->cookie->id_customer)
                ));

            // Instance of module class for translations
            $module = new advansedwishlist();

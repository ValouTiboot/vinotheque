...
{if $products}
	...
	{foreach from=$products item=product name=i}
		<dt class="{if $smarty.foreach.i.first}first_item{elseif $smarty.foreach.i.last}last_item{else}item{/if}">
			...
			<a class="ajax_cart_block_remove_link" href="javascript:;" onclick="javascript:WishlistCart('wishlist_block_list', 'delete', '{$product.id_product|escape:'htmlall':'UTF-8'}', {$product.id_product_attribute|escape:'htmlall':'UTF-8'}, '0');" title="{l s='remove this product from my wishlist' mod='advansedwishlist'}" rel="nofollow"><img src="{$img_dir|escape:'htmlall':'UTF-8'}icon/delete.gif" width="12" height="12" alt="{l s='Delete' mod='advansedwishlist'}" class="icon" /></a>
		</dt>

...
class CombinationCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'shop_quantity' => array('type' => self::TYPE_INT, 'shop' => true, 'validate' => 'isInt', 'size' => 11),
            'packaging_price' => array('type' => self::TYPE_FLOAT, 'shop' => true, 'validate' => 'isPrice', 'size' => 20),
            'id_product_attribute_dubos' => array('type' => self::TYPE_INT, 'validate' => 'isInt', 'size' => 11),
            'id_packaging' => array('type' => self::TYPE_INT, 'validate' => 'isInt', 'size' => 11),
        ),
    );

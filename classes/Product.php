...
class ProductCore extends ObjectModel
{
    ...
    */
        ...
        $id_images, $reference, $ean13, $default, $location = null, $upc = null, $minimal_quantity = null, $available_date = null, $update_all_fields = true, array $id_shop_list = array(), $isbn = '', $shop_quantity = null, $packaging_price)
    {
        ...
        $combination->shop_quantity = $shop_quantity;
        $combination->packaging_price = $packaging_price;
    ...
    public function addAttribute($price, $weight, $unit_impact, $ecotax, $id_images, $reference, $ean13,
            $default, $location = null, $upc = null, $minimal_quantity = 1, array $id_shop_list = array(), $available_date = null, $quantity = 0, $isbn = '', $shop_quantity = null, $packaging_price)
    {
        if (!$this->id) {
            return;
        }

...
{/if}
                ...
                *}
                <p class="submit">
                    <button type="submit" id="submitSponsorFriends" name="submitSponsorFriends" class="btn btn-primary"><span>{l s='Validate' mod='referralbyphone'}</span></button>
                </p>
            </form>
        {else}
    ...
    <ul>
        <li>
            <a href="{$link->getPageLink('my-account', true)|escape:'htmlall':'UTF-8'}" title="{l s='Back to Your Account' mod='referralbyphone'}" rel="nofollow">
                <span>< {l s='Back to Your Account' mod='referralbyphone'}</span></a>
        </li>
		{*

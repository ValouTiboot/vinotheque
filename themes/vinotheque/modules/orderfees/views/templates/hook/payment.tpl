...
{else}    
    {if $total > 0}
        <span class="pull-right">{l s='+ additional fees : %s' mod='orderfees' sprintf={displayPrice price=$total}}</span>
    {else}
        <span class="pull-right">{l s='%s' mod='orderfees' sprintf={displayPrice price=$total}}</span>
    {/if}
{/if}

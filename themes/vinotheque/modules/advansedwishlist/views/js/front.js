		...
		success: function(data)
		{
			if (action == 'add')
			{
				if (isLogged == true) {
					...
					// $("#wishlist_button_block").html('<a href="#" id="wishlist_button" onclick="return false;"><i class="icon-heart"></i>Added to wishlist</a>');
...
function WishlistProductManage(id, action, id_wishlist, id_product, id_product_attribute, quantity, priority)
{
	$.ajax({
		type: 'GET',
		async: true,
		url: baseDir + 'modules/advansedwishlist/managewishlist.php?rand=' + new Date().getTime(),
		headers: { "cache-control": "no-cache" },
...
function WishlistDefault(id, id_wishlist)
{
	...
	$.ajax({
		...
		success: function (data)
		{
			...
			td_default.append('<p class="is_wish_list_default"><i class="material-icons">assignment_turned_in</i></p>');
		}
	});
}
...
jQuery(document).ready(function($){
	...
	$(".wish_link, .wrap_allert").hover(function(){

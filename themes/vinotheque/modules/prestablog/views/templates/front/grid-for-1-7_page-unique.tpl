...
<div id="prestablog_recette_img_responsive" class="container-fluid">
    <div class="container">
...
<div class="row justify-content-center">
    ...
    <!-- /If we are in Recette catégory -->
            ...
            <div id="rrssb-buttons">
                ...
                <ul class="rrssb-buttons clearfix pull-right">
                    {if $prestablog_config.prestablog_s_facebook}
                        <li class="facebook">
                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={$prestablog_current_url|escape:'url':'UTF-8'}" class="popup">
                        <span class="icon">
                    ...
                    {if $prestablog_config.prestablog_s_twitter}
                        <li class="twitter">
                            <a target="_blank" href="http://twitter.com/home?status={$news->title|escape:'url':'UTF-8'}%20{$prestablog_current_url|escape:'url':'UTF-8'}" class="popup">
                        <span class="icon">
                    ...
                    {if $prestablog_config.prestablog_s_googleplus}
                        <li class="googleplus">
                            <a target="_blank" href="https://plus.google.com/share?url={$prestablog_current_url|escape:'url':'UTF-8'}" class="popup">
                        <span class="icon">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                                <g>
                                    <g>
                    ...
                    {if $prestablog_config.prestablog_s_linkedin}
                        <li class="linkedin">
                            <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url={$prestablog_current_url|escape:'url':'UTF-8'}&title={$news->title|escape:'url':'UTF-8'}&summary={$news->title|escape:'url':'UTF-8'}" class="popup">
                        <span class="icon">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                    ...
                    {if $prestablog_config.prestablog_s_email}
                        <li class="email">
                            <a target="_blank" href="mailto:?subject={$news->title|escape:'url':'UTF-8'}&amp;body={$prestablog_current_url|escape:'url':'UTF-8'}">
                        <span class="icon">
                    ...
                    {if $prestablog_config.prestablog_s_pinterest}
                        <li class="pinterest">
                            <a target="_blank" href="http://pinterest.com/pin/create/button/?url={$prestablog_current_url|escape:'url':'UTF-8'}&amp;media={$prestablog_root_url_path|escape:'url':'UTF-8'}{$prestablog_theme_upimgnoslash|escape:'url':'UTF-8'}thumb_{$news->id|intval}.jpg&amp;description={$news->title|escape:'url':'UTF-8'}">
                        <span class="icon">
                    ...
                    {if $prestablog_config.prestablog_s_pocket}
                        <li class="pocket">
                            <a target="_blank" href="https://getpocket.com/save?url={$prestablog_current_url|escape:'url':'UTF-8'}">
                        <span class="icon">
                    ...
                    {if $prestablog_config.prestablog_s_tumblr}
                        <li class="tumblr">
                            <a target="_blank" href="http://tumblr.com/share/link?url={$prestablog_current_url|escape:'url':'UTF-8'}&name={$news->title|escape:'url':'UTF-8'}">
                        <span class="icon">
                    ...
                    {if $prestablog_config.prestablog_s_reddit}
                        <li class="reddit">
                            <a target="_blank" href="http://www.reddit.com/submit?url={$prestablog_current_url|escape:'url':'UTF-8'}&title={$news->title|escape:'url':'UTF-8'}&text={$news->title|escape:'url':'UTF-8'}">
                        <span class="icon">
                    ...
                    {if $prestablog_config.prestablog_s_hackernews}
                        <li class="hackernews">
                            <a target="_blank" href="https://news.ycombinator.com/submitlink?u={$prestablog_current_url|escape:'url':'UTF-8'}&t={$news->title|escape:'url':'UTF-8'}&text={$news->title|escape:'url':'UTF-8'}">
                        <span class="icon">
                            <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
        ...
        <div class="two_drops_separator"></div>
        <div id="blog_product_linked">
            <h3 class="page_title">{l s='Related products' mod='prestablog'}</h3>
            <div class="products row">
                {foreach from=$news->products_liaison item=product key=key name=current}
                    {*TODO: Mettre les bonnes valeurs dans $news->products_liaison*}

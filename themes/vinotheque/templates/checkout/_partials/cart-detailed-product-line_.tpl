...
{block name='cart_detailed_product_line'}
  <div class="product-image col-md-2 col-4"><img src="{$product.cover.small.url}"></div>
  <div class="product-infos col-md-6 col-4">
    ...
    {block name='cart_detailed_product_line_customization'}
      ...
      {/if}
    {/block}
  <span class="product-availability">{$product.availability}</span><br>
  </div>

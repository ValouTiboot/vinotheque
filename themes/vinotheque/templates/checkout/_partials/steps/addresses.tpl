...
{block name='step_content'}
  <div class="js-address-form">
    ...
    {elseif $customer.addresses|count > 0}
      ...
      <a class="add-address" href="{$new_address_delivery_url}">+ {l s='Add a new address' d='Shop.Theme.Actions'}</a>

      {if $use_same_address && !$cart.is_virtual}
        <br>
        <a class="different-address" data-link-action="different-invoice-address" href="{$use_different_address_url}">
    ...
    {if !$use_same_address}
      ...
      {else}
        ...
        <a class="add-address" href="{$new_address_invoice_url}">+ {l s='Add a new address' d='Shop.Theme.Actions'}</a>

        ...
        <div id="cart_details" class="col-12 col-lg-4">
			...
			{block name='cart_actions'}
				{if $cart.minimalPurchaseRequired}
                    ...
                    <button class="btn btn-primary" disabled>{l s='Checkout' d='Shop.Theme.Actions'}</button>
				{elseif empty($cart.products)}
                    <button class="btn btn-primary" disabled>{l s='Checkout' d='Shop.Theme.Actions'}</button>
				{else}
                    <a class="btn btn-primary" href="{$urls.pages.order}">{l s='Checkout' d='Shop.Theme.Actions'}</a>

...
class AdminModelAdapter extends \PrestaShopBundle\Model\AdminModelAdapter
{
    ...
    public function __construct(
        ...
        $this->multishopKeys = array('category_box',
            ...
            'attribute_packaging_price',
            'attribute_shop_quantity',
    ...
    public function getFormData()
    {
        $form_data = [
            ...
            'step1' => [
                ...
                'id_second_wine' => $this->product->id_second_wine,
            ...
            'step3' => [
                ...
                'shop_quantity' => $this->product->shop_quantity,
            ...
            'step6' => [
                ...
                'wine' => (bool) $this->product->wine,
                'wine_date' => $this->product->wine_date,
                'wine_delivery' => $this->product->wine_delivery,
                'tags' => $this->getTags(),
                'display_options' => [

...
class ProductInformation extends CommonAbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('property', 'PrestaShopBundle\Form\Admin\Type\TranslateType', array(
            'type' => 'Symfony\Component\Form\Extension\Core\Type\TextareaType',
            'options' => [
                'attr' => array('class' => 'autoload_rte'),
                'required' => false
            ...
            'locales' => $this->locales,
            'hideTabs' => true,
            'label' =>  $this->translator->trans('Property', [], 'Admin.Global'),
            'required' => false
        ))
        ->add('calling', 'PrestaShopBundle\Form\Admin\Type\TranslateType', array(
            'type' => 'Symfony\Component\Form\Extension\Core\Type\TextareaType',
            'options' => [
                'attr' => array('class' => 'autoload_rte'),
                'required' => false
            ...
            'locales' => $this->locales,
            'hideTabs' => true,
            'label' =>  $this->translator->trans('Calling', [], 'Admin.Global'),
            'required' => false
        ))

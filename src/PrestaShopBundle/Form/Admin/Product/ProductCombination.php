...
class ProductCombination extends CommonAbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('attribute_packaging_price', 'Symfony\Component\Form\Extension\Core\Type\MoneyType', array(
            'required' => false,
            'label' => $this->translator->trans('Packaging price', [], 'Admin.Catalog.Feature'),
            'currency' => $this->currency->iso_code,
            'attr' => ['class' => 'attribute_packaging_price']
        ))
        ...
        if ($is_stock_management){
           ...
           ->add('attribute_shop_quantity', 'Symfony\Component\Form\Extension\Core\Type\NumberType', array(
                'required' => true,
                'label' => $this->translator->trans('Shop Quantity', [], 'Admin.Catalog.Feature'),
                'constraints' => array(
                    new Assert\NotBlank(),
                    new Assert\Type(array('type' => 'numeric')),
                )

...
class ProductOptions extends CommonAbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('wine', 'Symfony\Component\Form\Extension\Core\Type\CheckboxType', array(
            'label'    => $this->translator->trans('Wine', [], 'Admin.Catalog.Feature'),
            'required' => false,
        ))
        ->add('wine_date', 'PrestaShopBundle\Form\Admin\Type\DatePickerType', array(
            'required' => false,
            'label' => $this->translator->trans('Available date wine', array(), 'Admin.Catalog.Feature'),
            'attr' => ['class' => 'date', 'placeholder' => 'YYYY-MM-DD'],
        ))
        ->add('wine_delivery', 'PrestaShopBundle\Form\Admin\Type\DatePickerType', array(
            'required' => false,
            'label' => $this->translator->trans('Delivery date wine', array(), 'Admin.Catalog.Feature'),
            'attr' => ['class' => 'date', 'placeholder' => 'YYYY-MM-DD'],
        ))

...
class ProductDataProvider
{
     ...
     * @return int stock
     */
    public function getShopQuantity($id_product, $id_product_attribute = null, $cache_is_pack = null)
    {
        return \ProductCore::getShopQuantity($id_product, $id_product_attribute, $cache_is_pack);
    }

...
class CombinationDataProvider
{
    ...
    public function completeCombination($attributesCombinations, $product)
    {
        ...
        return array(
            ...
            'attribute_packaging_price' => $combination['packaging_price'],
            ...
            'attribute_shop_quantity' => $this->productAdapter->getShopQuantity($product->id, $combination['id_product_attribute']),
